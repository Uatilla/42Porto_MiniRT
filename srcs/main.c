...
int main(void)
{
	...
	m.specular = 0.9;
	m.shininess = 200;
	m.pattern = stripe_pattern(&(t_color){1, 1, 1, 1}, &(t_color){0, 0, 0, 1});
	mtx_translation(m.pattern.trans, &(t_point){0.5, 0, 0, 1});
	...
	color = stripe_at_obj(&m.pattern, &(t_point){2.5, 0, 0, 1}, data.world.objs);
...
// 	m.specular = 0.9;
// 	m.shininess = 200;
// 	m.pattern = stripe_pattern(&(t_color){0.1, 0.25, 0.9, 1}, &(t_color){0.42, 0.81, 0.1, 1});
//
// 	t_matrix *ball_sc_1;
...
// 	m_2.specular = 0.9;
// 	m_2.shininess = 200;
// 	m_2.pattern = stripe_pattern(&(t_color){0.5, 0.25, 0.5, 1}, &(t_color){0.2, 1, 1, 1});
//
// 	t_matrix *ball_trans;
...
// 	floor.specular = 0.9;
// 	floor.shininess = 200;
// 	floor.pattern = stripe_pattern(&(t_color){1, 0, 0.5, 1}, &(t_color){0.5, 1, 0, 1});
//
