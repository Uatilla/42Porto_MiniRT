...
int	main(int argc, char **argv)
{
	...
	//LIGHT
	//point_light(&(t_point){0, 0, -4.5, 1}, &(t_color){1, 0.1, 0.1, 999999}, &data.world);
	//Moved to parse_line
	...
	//data.camera.trans = view_transformation(&(t_point){0, 0, -10, 1}, &(t_point){0, 0, 0, 1}, &(t_vector){1, 0, 0, 0});
