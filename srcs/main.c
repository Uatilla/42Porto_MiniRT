...
/*   Updated: 2024/08/19 17:02:57 by Jburlama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	parse_sphere(&world);
	parse_sphere(&world);
	set_light(&(t_point){1, 1, 1, 1}, &(t_point){1, 1, 1, 1}, &world);
	set_light(&(t_point){2, 2, 2, 2}, &(t_point){2, 2, 2, 2}, &world);
	parse_sphere(&world);
	parse_sphere(&world);
	parse_sphere(&world);
	parse_sphere(&world);
	set_light(&(t_point){3, 3, 3, 3}, &(t_point){3, 3, 3, 3}, &world);
	set_light(&(t_point){3, 3, 3, 3}, &(t_point){3, 3, 3, 3}, &world);
	set_light(&(t_point){3, 3, 3, 3}, &(t_point){3, 3, 3, 3}, &world);
