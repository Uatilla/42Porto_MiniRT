...
// 	m.specular = 0.9;
// 	m.shininess = 200;
// 	m.pattern = stripe_pattern(&(t_color){1, 1, 1, 1}, &(t_color){0, 0, 0, 0}, RNG);
...
//
// 	color = pattern_at(&m.pattern, &(t_point){0.78, 0, 0.78, 1}, data.world.objs, data.world.objs->material.pattern.type);
//
